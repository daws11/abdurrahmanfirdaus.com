...
export const projectStories: ProjectStory[] = [
  ...
  },
  {
    ...
    fdeCallout:
      "The trigger wasn't a feature gap — it was a delivery gap. A friend spent three hours trying to send his mother a song for her 60th birthday, and nothing on the market met the bar of what you'd actually want to receive in a message. The product, in hindsight, was already there. The WhatsApp surface wasn't. So we built a WhatsApp-first flow where the song itself is the gift — and what you see in the live capture below is what that delivery-first instinct became.",
    story:
