...
export function FocusRail({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[660px] md:h-[600px] w-full flex-col overflow-hidden bg-neutral-950 text-white outline-none select-none overflow-x-hidden",
        className
      )}
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
          ...
          {visibleIndices.map((offset) => {
            ...
            return (
              <motion.div
                ...
                // Bouncier TAP_SPRING for scale ("tap" feedback), BASE_SPRING for the rest
                transition={{
                  default: BASE_SPRING,
                  scale: TAP_SPRING,
                }}
        ...
        {/* Info & Controls */}
        <div className="mx-auto mt-6 md:mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left min-h-32 justify-center">
